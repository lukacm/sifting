...
int cost_Gates(short*[], int, int*&, int);
int inter_Gates_Cost(short*[], int*, int, int**, int**&, int);
int gates_Cost(int*[], int*, int, int);
int init_Gate_sims(int*, int, int**, int**&, int);
int init_Gate_Sims(int*, int, int**&, int**&);
int reorder_Real(short*[], int, int, int**,int**);
int block_gate_Extract(short*[], int, int**&, int**&, char);
